...
class Gardening():
    ...
    def CatTesting(self):
            try:
                ...
                Gardening = WebDriverWait(self.driver, 10).until(
                    EC.presence_of_element_located((By.XPATH, CatBooksLocators.H3_GARDENING)))
                Gardening.click()
                print("Clicked Gardening Category")
